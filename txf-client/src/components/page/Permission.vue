    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-cascader :options="options" :props='{ checkStrictly: true, value: "id", label: "title", children: "subs"}'
                    placeholder="上级权限" clearable class="mr10" @change="changePid"></el-cascader>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header"
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="text" icon="el-icon-lx-delete" class="red" @click="handleDelete(scope.$index, scope.row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog v-dialogDrag title="新增" :visible.sync="addVisible" width="30%" :close-on-click-modal="false">
            <el-form ref="addForm" :model="addForm" label-width="70px">
                ...
                <el-form-item label="上级权限">
                    <el-cascader :options="options" ref="cascaderInesrt" :props='{ checkStrictly: true, value: "id", label: "title", children: "subs"}'
                        placeholder="非必填" clearable class="mr10" @change="changeInsert"></el-cascader>
                </el-form-item>
        ...
        <el-dialog v-dialogDrag title="编辑" :visible.sync="editVisible" width="30%" :close-on-click-modal="false">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-alert class="mb20" title="注意：上级权限、类型 不允许修改，请删除后重新新增" type="error" center show-icon>
                </el-alert>
                ...
                <el-form-item label="上级权限">
                    <el-cascader :options="options" ref="cascaderUpdate" v-model="form.pid" disabled :props='{ checkStrictly: true, value: "id", label: "title", children: "subs"}'
                        placeholder="非必填" clearable class="mr10"></el-cascader>
                </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            saveAdd() {
                requestApi("permissionInsert", this.addForm).then(res => {
            ...
            saveEdit() {
                ...
                requestApi("permissionUpdate", this.form).then(res => {
