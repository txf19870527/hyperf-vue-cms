                    ...
                    this.$api
                        ...
                        .then((res) => {
                            if (res.code == 0) {
                                ...
                                localStorage.setItem('cms_username', res.data.name);
                                localStorage.setItem('cms_menus', JSON.stringify(res.data.menus));
                                localStorage.setItem('cms_routes', JSON.stringify(res.data.routes));
