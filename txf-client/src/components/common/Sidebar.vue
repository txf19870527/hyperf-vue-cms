                ...
                <template v-if="item.subs">
                    <el-submenu :index="item.index ? item.index : item.id.toString()" :key="item.id">
                        ...
                        <template v-for="subItem in item.subs">
                            <el-submenu
                                v-if="subItem.subs"
                                :index="subItem.index ? subItem.index : subItem.id.toString()"
                                :key="subItem.id"
                            >
                                ...
                                <el-menu-item
                                    ...
                                    :key="threeItem.id"
                                    :index="threeItem.index ? threeItem.index : threeItem.id.toString()"
                                    >{{ threeItem.title }}</el-menu-item
                                >
                            </el-submenu>
                            <el-menu-item v-else :index="subItem.index ? subItem.index : subItem.id.toString()" :key="subItem.id">{{
                                subItem.title
                            }}</el-menu-item>
                        </template>
                    </el-submenu>
